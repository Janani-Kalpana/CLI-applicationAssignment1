...
public class App1{
    ...
    public static void main(String[] args) {
        ...
        //Arrays
        String[] AcId = new String[0];
        String[] names = new String[0];
        int[] initialDeposit = new int[0];
            ...
            switch (screen){
                ...
                case Open_New_Acc:
                    ...
                    while(true){
                        ...
                        String[] newAcId = new String[AcId.length+1];
                        ...
                        int[] newDepo = new int[initialDeposit.length+1];
                        for (int i = 0; i < initialDeposit.length; i++) {
                            newDepo[i] = initialDeposit[i];
                        }
                        newDepo[newDepo.length -1] = initDepo;
                        newDepo = initialDeposit;
